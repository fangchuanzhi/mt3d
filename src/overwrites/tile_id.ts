...
export class OverscaledTileID {
    ...
    canonical: CanonicalTileID;
    key: string;
    posMatrix: Float32Array | undefined;
...
Object.defineProperty(CanonicalTileID,"_classRegistryKey",{
    value: "CanonicalTileID",
    writable: false
})
Object.defineProperty(OverscaledTileID,"_classRegistryKey",{
    value: "OverscaledTileID",
    writable: false
})
