...
export class Refractor {
    ...
    constructor(geometry:THREE.BufferGeometry, options:any) {
        ...
        var shader = options.shader || RefractorShader;
        ...
        var visible = (function () {
            ...
            return function visible(camera:CameraForMap) {

                refractorWorldPosition.setFromMatrixPosition(mesh.matrixWorld);
        ...
        var updateVirtualCamera = (function () {
            ...
            return function updateVirtualCamera(camera:CameraForMap) {

                virtualCamera.matrixWorld.copy(camera.matrixWorld);
                virtualCamera.matrixWorldInverse.getInverse(virtualCamera.matrixWorld);
                virtualCamera.projectionMatrix.copy(camera.projectionMatrix);
                virtualCamera.far = camera.farZ; // used in WebGLBackground
        ...
        this,mesh.onBeforeRender = function (renderer:THREE.WebGLRenderer, scene:THREE.Scene, camera:THREE.Camera) {
            ...
            if (!visible(camera as CameraForMap) === true) return;
            ...
            updateVirtualCamera(camera as CameraForMap);
